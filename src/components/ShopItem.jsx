  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-evenly h-full">
        <span className="text-xs md:text-lg text-blue font-semibold">
          {props.name.split("(")[0]}
        ...
        <span className="text-xs md:text-base text-blue font-semibold">
          {props.price} 
        </span>
      </div>
      {button === true && (
        <div className="w-full">
          <button
            className="py-4 text-blue text-xs md:text-base w-full block border-t hover:border-t-[#cda154] border-white hover:bg-[#cda154] hover:text-black font-medium duration-500"
