  ...
  return (
    <MainLayout>
      <div className="flex flex-col md:flex-row py-8 px-4 md:px-12 gap-4 justify-center">
        <div className="border-[1.6px] py-6 rounded-xl w-full md:w-1/2 text-blue relative">
          {isPayment === true && (
            <button
              className="absolute top-5 left-5 text-blue"
        ...
        <div className="border-[1.6px] h-64 p-6 rounded-xl w-full md:w-80 lg:w-96 text-blue flex flex-col whitespace-nowrap">
